...
exports.likeSauce = (req, res, next) => {
  ...
  Sauce.findOne({ _id: req.params.id })
    .then(sauce => {
        ...
        arrayLikingUsers = sauce.likingUsers;
        arrayDislikingUsers = sauce.dislikingUsers;
        if(like === 0) {
        ...
        Sauce.updateOne( {_id: req.params.id}, {likes: numberLikes, likingUsers: arrayLikingUsers, 
            dislikes: numberDislikes, dislikingUsers: arrayDislikingUsers})
